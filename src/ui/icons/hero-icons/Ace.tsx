...
const Ace = forwardRef<SVGSVGElement, AceProps>(function Ace({ className, width, height }, ref) {
  return (
    <svg
      ref={ref}
      viewBox="-5 -1 56 46"
